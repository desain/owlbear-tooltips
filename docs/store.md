---
title: Tooltips
description: Adds a mode to the pointer tool to view and manage token tooltips.
author: desain
...
learn-more: https://github.com/desain/owlbear-tooltips
tags:
    - tool
manifest: https://owlbear-tooltips.nicholassdesai.workers.dev/manifest.json
---

# Tooltips

Create tooltips for tokens that display when hovering over tokens using a custom tool.
